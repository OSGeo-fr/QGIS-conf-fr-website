...
<table class="tableizer-table">
  ...
  <tbody>
    ...
    <tr class="pair">
      <td>14:25</td>
      <td><a href="icetool--plugin-pour-créer-des-espaces-publics-plus-résilients-et-adaptés---evrard-arthur">ICEtool : plugin pour créer des espaces publics plus résilients et adaptés</a></td>
      <td>Evrard Arthur (INSA Toulouse & Egis)</td>
    </tr>
    <tr class="impair">
      <td>14:45</td>
    ...
    <tr class="pair">
      <td>15:15</td>
      <td><a href="identifier-les--dents-creuses--avec-un-plug-in-qgis---drochon-axel">Identifier les « dents creuses » avec un plug-in QGIS</a></td>
      <td>Axel Drochon (Atopia)</td>
    </tr>
    <tr class="pause">
      <td>15:40</td>
      <td>Pause</td>
...
### Identifier les « dents creuses » avec un plug-in QGIS - Drochon Axel

Pour atteindre l’objectif de Zéro Artificialisation Nette des sols (ZAN) en 2050, les (très) nombreuses parcelles non bâties en milieu bâti, dites « dents creuses », gagneraient à être aménagées pour minimiser l’étalement urbain. L’identification des dents creuses est utile pour tous les territoires que nous accompagnons. C’est dans un souci de traiter équitablement chaque territoire, avec une méthode systématisée et adaptée à toutes les échelles, que nous avons fait le choix de développer un plug-in QGIS qui puisse être directement utilisé par des non-géomaticiens. Il permet d’identifier rapidement les dents creuses d’un territoire. Bien que rediscutés lors des temps de concertation, les résultats obtenus via le plug-in permettent d’obtenir une base solide sur laquelle s’appuyer.
